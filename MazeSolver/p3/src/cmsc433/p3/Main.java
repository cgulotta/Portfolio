...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        */
        //System.out.println("numCores:" + Runtime.getRuntime().availableProcessors());
        //These lines are to run via Eclipse without a command prompt
        String mazeLocationNotInProjectFolder = "/home/charles/Downloads/maze-dist/"; //replace this with your maze directory
